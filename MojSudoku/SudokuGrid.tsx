...
const SudokuGrid: React.FC = () => {
  ...
  setHintButtonsVisible(!hintButtonsVisible);
  ...
  const getNumberButtonStyle = (title:string): ViewStyle => ({
    backgroundColor: lockedNumberButtons?.[title] ? 'rgba(43, 90, 45, 1)': 'rgba(76, 177, 81, 1)',
    flexDirection: 'row',
    padding: 5,
    width: 33,
    height: 50,
